...
ALTER TABLE "users" ALTER COLUMN "employee_id" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "role" varchar(20) DEFAULT 'employee' NOT NULL;--> statement-breakpoint
